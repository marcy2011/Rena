...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="news-grid">
                <?php
                $language = isset($_GET['lang']) ? $_GET['lang'] : (isset($_COOKIE['preferredLanguage']) ? $_COOKIE['preferredLanguage'] : 'it');
                    ...
                    foreach ($newsList as $index => $news) {
                        ...
                        <article class="news-item">
                            <div class="news-image">
                                <img src="<?= htmlspecialchars($news['cover']) ?>" alt="<?= htmlspecialchars($news['title']) ?>"
                                    class="news-cover">
                            </div>
                            <div class="news-content">
                                ...
                                <a href="view-news.php?id=<?= count($newsList) - 1 - $index ?>&lang=<?= $language ?>">
                                    <button class="read-more" data-translate-it="Leggi di più"
                                        data-translate-en="Read more">Leggi di più</button>
                                </a>
                            </div>
                        </article>
                        <?php
